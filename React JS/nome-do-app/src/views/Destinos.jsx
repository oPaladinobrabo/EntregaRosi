        ...
        <table class="table2" />
            <tr>
                <td class="immg">
                    ...
                    <hr />
                    <font class="font1">R$ 788,00</font><br />
                ...
                <td class="immg">
                    ...
                    <hr />
                    <font class="font1">R$ 3.889,00</font><br />
                ...
                <td class="immg">
                    ...
                    <hr />
                    <font class="font1">R$ 1.089,00</font><br />
                    <font class="font2">5 dias hospedado(s) na encantada Pousada Magia.</font><br />
                </td>
                <td class="immg">
             ...
             <td class="immg">
                    ...
                    <hr />
                    <font class="font1">R$ 1.189,00</font><br />
                ...
                <td class="immg">
                    ...
                    <hr />
                    <font class="font1">R$ 384,00</font><br />
